...
- (void)buildBackgroundImage {
    ...
    self.bgImageView.frame = CGRectMake(110/2, 95.0/2, 560/2, 915.0/2);
    ...
    self.pageBgBack = [[UIImageView alloc] initWithFrame:self.bgImageView.frame];
    ...
    self.pageBgFront = [[UIImageView alloc] initWithFrame:self.bgImageView.frame];
...
- (UIView *)viewForPage:(LQIntroPage *)page atXIndex:(CGFloat *)xIndex {
...
- (UIImage *)bgForPage:(NSInteger)idx {
    ...
    return ((LQIntroPage *)_pages[idx]).bgImage;
}
...
- (void)setSkipButton:(UIButton *)skipButton {
    ...
    [self.scrollView addSubview:_skipButton];
}
